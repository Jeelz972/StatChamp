  ...
  const getMatchStats = () => {
    ...
    currentMatchStats.quartersData.forEach(quarter => {
      quarter.actions.forEach(action => {
        if (action.team === 'nous') {
          if (action.type === 'panier_2pts') stats.nous.paniers2pts++;
          if (action.type === 'panier_3pts') stats.nous.paniers3pts++;
          if (action.type === 'lancer_franc') stats.nous.lancersFrancs++;
          if (action.type === 'tir_loupe') stats.nous.tirsLoupes++;
          if (action.type === 'rebond_offensif_nous') stats.nous.rebondsOffensifs++;
          if (action.type === 'perte_balle') stats.nous.pertesDeBalle++;
          if (action.type === 'interception') stats.nous.interceptions++;
          ...
          if (action.type === 'panier_2pts') stats.adversaire.paniers2pts++;
          if (action.type === 'panier_3pts') stats.adversaire.paniers3pts++;
          if (action.type === 'tir_loupe') stats.adversaire.tirsLoupes++;
          if (action.type === 'rebond_offensif_adv') stats.adversaire.rebondsOffensifs++;
      ...
      <div className="bg-white rounded-lg shadow-lg p-4">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            ...
            <button
              onClick={() => addAction('tir_loupe', 'nous', 0)}
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            ...
            <button
              onClick={() => addAction('tir_loupe', 'adversaire', 0)}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-blue-600">{getMatchStats().nous.paniers2pts}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Paniers 3 points:</span>
                      <span className="font-bold text-blue-600">{getMatchStats().nous.paniers3pts}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Lancers Francs:</span>
                      <span className="font-bold text-blue-600">{getMatchStats().nous.lancersFrancs}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Tirs Loupés:</span>
                      <span className="font-bold text-orange-600">{getMatchStats().nous.tirsLoupes}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Rebonds Offensifs:</span>
                      <span className="font-bold text-cyan-600">{getMatchStats().nous.rebondsOffensifs}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Pertes de Balle:</span>
                      <span className="font-bold text-orange-600">{getMatchStats().nous.pertesDeBalle}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Interceptions:</span>
                      <span className="font-bold text-purple-600">{getMatchStats().nous.interceptions}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-700">Paniers 2 points:</span>
                      <span className="font-bold text-red-600">{getMatchStats().adversaire.paniers2pts}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Paniers 3 points:</span>
                      <span className="font-bold text-red-600">{getMatchStats().adversaire.paniers3pts}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Tirs Loupés:</span>
                      <span className="font-bold text-pink-600">{getMatchStats().adversaire.tirsLoupes}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Rebonds Offensifs:</span>
                      <span className="font-bold text-rose-600">{getMatchStats().adversaire.rebondsOffensifs}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-700">Fautes:</span>
